...
private Map<String,String> identifiantsNB = new HashMap<>();
	...
	//ajouter ident à la map
	public void ajouterIdentifiant() {
		List<String> res = FileHandler.readFileToList("../../pfr/image/descripteurs_images/base_image_couleur.txt");
		...
		res=FileHandler.readFileToList("../../pfr/image/descripteurs_images/base_image_NB.txt");
		for (String string : res) {
			String[] parts = string.split(" "); // Splitting the string at the space character
