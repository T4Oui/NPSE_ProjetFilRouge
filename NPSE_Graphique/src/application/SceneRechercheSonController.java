...
public class SceneRechercheSonController implements Initializable{
	...
	@FXML
	public void clickButtonRecherche(ActionEvent event) throws Exception {if (!(entrerRecherche.getText().isEmpty() || entrerRecherche.getText().isBlank())) {
		...
		controller.typeRecher(TypeRecherche.SON);
	...
	public void clickButtonChoisirFichier(ActionEvent event) {
		    ...
		    ExtensionFilter xmlFilter = new ExtensionFilter("Fichiers WAV (*.wav)", "*.wav");
