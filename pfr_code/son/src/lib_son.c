#include <stdio.h>
#include <stdlib.h>
//#include "../../pfr_code/son/include/lib_son.h"
...
//strngs pour accéder aux fichiers ---------------------------------------------
    char chemin_desc [256] ="../../pfr/son/descripteurs_sons/";
    char chemin_fich_sons[256] = "../../pfr/son/fich_sons/";
    ...
    if (fichier != NULL){
        ...
        while( fread(&echantillon,sizeof(double),1, fichier ) == 1 ){
            ...
            if (i_echant == n) {
                ...
                FILE* fic_descr = fopen("../../pfr/son/descripteurs_sons/descripteur_corpus_fi.bin.txt","a");
